      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl">
            Hey, I&apos;m Tilk<span className="sm:hidden inline-block animate-wave ml-2">👋</span><span className="sm:inline-block hidden animate-wave ml-2">👋</span>
          </h1>
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            <SocialIcon
              url="https://github.com/PythonTilk"
            ...
            />
            <SocialIcon
              url="https://discord.com/users/770320288030130226"
